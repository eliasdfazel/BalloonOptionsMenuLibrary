...
import net.geeksempire.balloon.optionsmenu.library.R;
...
//     */
    public CircleMenuView(@NonNull AppCompatActivity context, @NonNull List<Drawable> icons, @NonNull List<Integer> colors) {
        ...
        initButtonsByDrawable(context, icons, colors);
    }
    ...
    private void initButtonsByResources(@NonNull Context context, @NonNull List<Integer> icons, @NonNull List<Integer> colors) {
    ...
    private void initButtonsByDrawable(@NonNull Context context, @NonNull List<Drawable> icons, @NonNull List<Integer> colors) {
        ...
        for (int i = 0; i < buttonsCount; i++) {
            ...
            floatingActionButton.setImageDrawable(icons.get(i));

            floatingActionButton.setImageTintList(ColorStateList.valueOf(Color.TRANSPARENT));
            floatingActionButton.setImageTintMode(PorterDuff.Mode.ADD);

            floatingActionButton.setBackgroundTintList(ColorStateList.valueOf(colors.get(i)));
            ...
            floatingActionButton.setLayoutParams(new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT));
